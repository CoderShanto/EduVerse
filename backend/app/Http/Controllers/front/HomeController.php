...
public function stats()
{
    ...
    // unique learners (unique user_id in enrollments)
    $learners = Enrollment::distinct('user_id')->count('user_id');

    // total lessons/materials
    $materials = Lesson::where('status', 1)->count(); // if you have status
    // if you don’t have status in lessons, do: Lesson::count();

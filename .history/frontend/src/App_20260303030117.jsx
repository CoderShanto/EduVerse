...
import InstructorDashboard from "./components/pages/account/instructor/Dashboard";
import AdminDashboard from "./components/pages/account/admin/AdminAnalytics";
import AdminAllCourses from "./components/pages/account/admin/AdminAllCourses";
...
import Showcase from './components/pages/innovation/Showcase'
import ShowcaseDetails from './components/pages/innovation/ShowcaseDetails'
import Leaderboard from './components/pages/innovation/Leaderboard'
import Portfolio from './components/pages/account/Portfolio'
import Certificates from './components/pages/account/Certificates'
import PublicPortfolio from './components/pages/account/PublicPortfolio'
import Aboutus from './components/common/Aboutus'
import AdminCategories from "./components/pages/account/admin/AdminCategories";
...
/>
        ...
        />
                ...
                <Route path="/account/innovation/showcase" element={
          <RequireAuth>
            <RequireRole roles={['student','instructor','admin']}>
              <Showcase />
            </RequireRole>
        ...
        <Route path="/account/innovation/showcase/:id" element={
          <RequireAuth>
            <RequireRole roles={['student','instructor','admin']}>
              <ShowcaseDetails />
            </RequireRole>
       ...
       <Route
  path="/account/innovation/leaderboard"
  element={
    <RequireAuth>
      <RequireRole roles={['student','instructor','admin']}>
        <Leaderboard />

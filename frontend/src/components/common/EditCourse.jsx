...
const EditCourse = ({ course, deleteCourse }) => {
  // ✅ Build best possible image URL (Cloudinary first, then filename fallback)
  const raw =
  ...
  // if backend gave filename like "1772495784-29.jpg"
    ...
    <div className="col-md-4">
      <div className="card border-0 position-relative">
        <div className="card-img-top position-relative">
          ...
          {String(course?.status) === "0" && (
            <span className="fw-bold badge bg-light text-muted position-absolute top-0 end-0 m-2">
              Draft
            </span>
          )}
        ...
        <div className="card-footer bg-white">
          <div className="d-flex py-2 justify-content-between align-items-center">
            <div className="add-to-cart">
              <Link to={`/account/courses/edit/${course?.id}`} className="btn btn-primary">
                Edit
              </Link>
              <button
                type="button"

...
const css = `
  ...
  .dt-enroll-btn:disabled { opacity: 0.7; cursor: not-allowed; transform: none; }
        ...
        {!loading && course && (
          <div className="container dt-inner pb-5">
            <div className="dt-hero">
              ...
              <div className="dt-hero-deco d1" />
              <div className="dt-hero-deco d2" />
              <div className="dt-hero-deco d3" />
              <div className="dt-hero-body">
                ...
                <div className="dt-hero-meta">
                  ...
                  <span className="dt-meta-chip">
                    🌐 <b>{course.language?.name}</b>
                  </span>

                  <span className="dt-meta-chip">
                    📶 <b>{course.level?.name}</b>
                  </span>
                </div>

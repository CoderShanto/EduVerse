...
const EditCourse = () => {
  ...
  const [statusLoading, setStatusLoading] = useState(false); // ✅ separate loader for publish btn
  ...
  const changeStatus = async (course) => {
    ...
    try {
      ...
      if (result.status == 200) {
        // ✅ Check if the backend actually changed the status
        // or just returned 200 with a warning (no chapters/lessons)
        ...
        if (actualStatus === newStatus) {
          ...
          // Backend blocked it (no chapters / no lessons) — show warning
          toast.error(result.message);
          // ✅ Keep course state as-is (don't update status)
        }
      } else {
            ...
            <div className="col-md-12 mt-5 mb-3">
              <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="d-flex gap-2">
                  ...
                  {/* ✅ Single smart Publish/Unpublish button */}
                  <button

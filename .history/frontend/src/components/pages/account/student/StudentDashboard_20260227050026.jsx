...
const css = `
  ...
  .sd-timer-display { font-size: 2.4rem; font-weight: 700; letter-spacing: 0.04em; line-height: 1; margin-bottom: 1rem; }
  ...
  .sd-quick-link .ql-arrow { margin-left: auto; opacity: 0.35; font-size: 0.8rem; }
  ...
  .sd-quote-mark { font-family: 'Playfair Display', serif; font-size: 3.5rem; color: #e8a75a; line-height: 0.8; flex-shrink: 0; margin-top: 0.3rem; }
...
const StudyTimer = () => {
  ...
  return (
    <div className='sd-timer-card'>
      ...
      <div style={{ fontSize: '0.72rem', color: 'rgba(255,255,255,0.45)', marginTop: '0.8rem' }}>
  ...
  return (
    <div className='sd-card'>
      ...
      <div className='sd-prog-track' style={{ marginBottom: '1rem' }}>
        <div className='sd-prog-fill' style={{ width: `${(done / DAILY_GOALS.length) * 100}%` }} />
      </div>
...
const StudentDashboard = () => {
  ...
  const initials = (userName || 'Student').split(' ').map(w => w[0]).join('').slice(0,2).toUpperCase()

...
const css = `
  ...
  .ml-hero {
    ...
    animation: ml-up 0.6s cubic-bezier(0.22,1,0.36,1) both;
  ...
  .ml-search-wrap {
    ...
    animation: ml-up 0.5s 0.1s both;
  }
  .ml-search-icon {
...
const getImage = (e) => e?.course?.course_small_image ?? e?.course?.image ?? e?.course_small_image ?? e?.image ?? ''
  ...
  return (
    <Layout>
      ...
      <div className='ml-blob-wrap'>
        <div className='ml-blob ml-blob-1' /><div className='ml-blob ml-blob-2' /><div className='ml-blob ml-blob-3' />
      </div>
          ...
          <div className='row'>
            ...
            <div className='col-lg-9 mt-4 mt-lg-0'>
              ...
              <div className='ml-hero mb-4'>
                <div className='ml-hero-deco d1' /><div className='ml-hero-deco d2' />

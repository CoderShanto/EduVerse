...
const Certificates = () => {
  ...
  // ✅ Download PDF (must use fetch because route is protected + needs Bearer token)
  const downloadPdf = async (cert) => {
    try {
      ...
      a.href = url
      a.download = `Certificate-${cert.certificate_no}.pdf`
      ...
      console.log(e)
      toast.error('Server error downloading certificate')
    } finally {

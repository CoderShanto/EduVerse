...
const ProblemHub = () => {
  ...
  const authToken = configToken // replace with context token if you use AuthContext here
                ...
                <div className='card h-100'>
                  <div className='card-body'>
                    <div className='d-flex justify-content-between'>
                      ...
                      <span className={`badge ${p.status === 'open' ? 'bg-success' : p.status === 'building' ? 'bg-warning text-dark' : 'bg-dark'}`}>
                        {p.status}
                      </span>
                    </div>
                    ...
                    <div className='d-flex justify-content-between align-items-center'>
                      <small className='text-muted'>
                        Posted by: {p.user?.name || 'Unknown'}
                      </small>

                      {/* Later: Link to /innovation/problem/:id */}

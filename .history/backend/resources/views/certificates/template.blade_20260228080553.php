...
<div class="page">
    ...
    <div class="main">
        ...
        <!-- HEADER -->
        <div class="header">
            <div class="org-name">EduVerse Platform &nbsp;&middot;&nbsp; Excellence in Education</div>
            ...
            <tr>
                ...
                <td class="footer-mid-col">
                    <svg width="38mm" height="38mm" viewBox="0 0 160 160" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <text x="80" y="111" text-anchor="middle" font-size="7" font-family="DejaVu Sans" fill="#8B6200" letter-spacing="1.2">EDUVERSE PLATFORM</text>
                ...
                <td class="footer-right-col">
                    ...
                    <!-- ══ SHANTO — BOLD EXECUTIVE SIGNATURE ══ -->
                    <svg width="62mm" height="22mm" viewBox="0 0 280 100" xmlns="http://www.w3.org/2000/svg">
                        <!-- S — aggressive thick double-curve loop -->
                        <path d="M 14,48 C 4,26 16,6 32,14 C 46,22 40,40 22,42 C 4,44 2,64 20,70 C 38,76 58,62 55,46"
                              fill="none" stroke="#1a1050" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <!-- h — very tall stem, clean arch -->
                        <path d="M 62,4 L 60,72"
                              fill="none" stroke="#1a1050" stroke-width="3.5" stroke-linecap="round"/>
                        <path d="M 60,44 C 72,26 88,28 88,46 L 86,72"
                              fill="none" stroke="#1a1050" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <!-- a — wide round loop with exit tail -->

   ...
   public function saveCourseImage($id, Request $request)
{
    ...
    // Generate small thumbnail URL (750x450 crop)
    $smallUrl = cloudinary()->image($publicId)
    ...
    // Keep old field if you want (optional)
    $course->image = basename(parse_url($imageUrl, PHP_URL_PATH));

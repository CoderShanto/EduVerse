  ...
  return (
    <div className='sd-card'>
      ...
      <div className='sd-prog-track' style={{ marginBottom: '1rem' }}>
        <div className='sd-prog-fill' style={{ width: `${(done / DAILY_GOALS.length) * 100}%`, background: done === DAILY_GOALS.length ? 'linear-gradient(90deg,#1a8c52,#34c17d)' : undefined }} />
      </div>
              ...
              <div className='sd-greeting mb-4'>
                <div className='sd-greeting-left'>
                  ...
                  <div className='sd-greeting-text'>
                    <h2>Good {getTimeGreeting()}, {user.user.name}! 👋</h2>
                          ...
                          <div key={i} className='sd-course-row'>
                            ...
                            <div className='sd-course-info'>
                              ...
                              <div className='sd-prog-track'>
                                <div className='sd-prog-fill' style={{ width: `${c.pct}%` }} />
                              </div>
                              <div className='sd-course-pct'>{c.pct}% complete</div>
                            </div>
                          </div>
                        ))}
                        <Link to='/account/my-learning' className='sd-stat-link' style={{ marginTop: '0.8rem', display: 'inline-flex' }}>All courses →</Link>
                      </div>
                    </div>
                    <div className='col-md-5'>
                      <div className='sd-card h-100'>

...
const AdminAllCourses = () => {
  ...
  const deleteCourse = async (courseId) => {
    ...
    try {
      ...
      // ⚠️ Change if your delete route differs
          ...
          <div className="col-lg-9">
            <div className="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-3">
              <div>
                ...
                <small className="text-muted">Search and manage every course.</small>
              </div>
                            ...
                            <tr key={c.id} className="aac-row">
                              ...
                              <td className="text-end">
                                <div className="aac-actions">
                                  {/* ✅ Change this to your real edit route if needed */}
            ...
            <div className="text-muted mt-2" style={{ fontSize: 12 }}>
              If your course image is a filename (like <code>123.jpg</code>), build the full URL in backend or here.
            </div>
          </div>
        </div>
      </div>

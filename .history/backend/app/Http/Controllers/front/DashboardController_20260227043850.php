    ...
    public function stats(Request $request)
    {
        try {
            ...
            if ($role === 'student') {
                ...
                // fallback: use activities if enrollments empty

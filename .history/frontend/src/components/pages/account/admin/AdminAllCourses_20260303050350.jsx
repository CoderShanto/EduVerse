...
const AdminAllCourses = () => {
  ...
  // ✅ IMPORTANT FIX:
  // Use authenticated endpoint /my-courses (admin should get ALL courses from backend)
        ...
        <div className="row">
          ...
          <div className="col-lg-9">
            ...
            <div className="text-muted mt-2" style={{ fontSize: 12 }}>
              Admin course list uses <code>/my-courses</code>. Make sure backend returns ALL courses for admin.
            </div>
          </div>
        </div>
      </div>
